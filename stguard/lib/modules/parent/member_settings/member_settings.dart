      ...
      builder: (context, state) {
        return Scaffold(
            ...
            body: Padding(
              ...
              child: state is GetDigitalIDStateLoading? const Center(child: CircularProgressIndicator(),): Column(
                children: [
                            ...
                            Row(
                              children: [
                                ...
                                Switch(
                                  ...
                                  value: ParentCubit.get(context).isPaired &&
                                      ParentCubit.get(context)
                                          .studentsPaths
                                          .keys
                                          .contains(student!.id) &&
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ParentCubit.get(context).location !=
                                                null
                                            ? ParentCubit.get(context)
                                                .location!
                                                .time
